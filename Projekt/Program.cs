    ...
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            using (var scope = app.Services.CreateScope())
            {
                ...
                if (adminUser == null)
                {
                    adminUser = new User { UserName = "admin@example.com", Email = "admin@example.com", Name = "Administrator" };
                ...
                if (normalUser == null)
                {
                    normalUser = new User { UserName = "user@example.com", Email = "user@example.com", Name = "Normal User" }; 
